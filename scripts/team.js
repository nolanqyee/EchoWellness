    ...
    gridItems.forEach((item, index) => {
        item.addEventListener('click', function() {
            ...
            const bios = [
                ...
                "Justin",
                "Jerry is a rising Junior at the Princeton International School of Math and Science. He enjoys playing tennis, researching sports technology, and contemplating the theoretical aspects of computer science and engineering. Driven by the vision of a world with less poverty, Jerry strives to create a happier community where everyone is better off, ultimately leading him to EchoWellness.",
                "Jin is a rising senior at Fox Chapel Area High School. He is interested in the fields of computer science and machine learning. At school, he is the captain of the fencing team and a part of the frisbee team. He also plays piano and snare drum for the marching band and bass guitar in the jazz band as well as for church worhsip.",
