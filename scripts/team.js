    ...
    gridItems.forEach((item, index) => {
        item.addEventListener('click', function() {
            ...
            const bios = [
                ...
                "Tristan Yuen is a senior at Cistercian Preparatory School. He loves studying biology and psychology. However, he is not just well-versed in the sciences. Led by his passion to serve, he uses his talents in music and academics to help make a positive impact on the world, whether it is through tutoring, performing, or research.",
                ...
                "Serena Zhu is a senior at Belmont High School. She likes the natural sciences and is well-versed in the visual and performing arts. Recognizing the importance of supporting the community, she strives to use her skills to improve other people's lives, creating a positive impact on the world.",
                ...
                "Kelly Yang is a Senior at The John Cooper School. She has a passion for chemistry, economics, and music. Kelly has been learning the piano since the age of 5, and singing since the age of 11. Driven by her passion to serve her community, Kelly utilizes her talents in academics and music to help make an impact by volunteering, teaching, and performing.",
